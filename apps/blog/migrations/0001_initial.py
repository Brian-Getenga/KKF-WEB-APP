    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('excerpt', models.CharField(blank=True, help_text='Brief description shown in listings', max_length=300)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, help_text='Name (for non-logged-in users)', max_length=100)),
                ('email', models.EmailField(blank=True, help_text='Email (for non-logged-in users)', max_length=254)),
            ...
            options={
                'ordering': ['created_at'],
                'indexes': [models.Index(fields=['post', 'approved', 'parent'], name='blog_commen_post_id_21f34e_idx')],
            },
        ),
        migrations.CreateModel(
            name='PostLike',
            ...
            options={
                'indexes': [models.Index(fields=['post', 'user'], name='blog_postli_post_id_641af3_idx')],
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['post', 'ip_address'], name='blog_postvi_post_id_e7b111_idx'), models.Index(fields=['-viewed_at'], name='blog_postvi_viewed__c6d1b4_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='blogpost',
